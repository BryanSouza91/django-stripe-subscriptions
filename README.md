...
This is a refactoring of the [stripe-samples/subscription-use-cases](https://github.com/stripe-samples/subscription-use-cases)/fixed-price-subscriptions python example. 
...
* [Stripe](https://stripe.com/docs) - Stripe Billing Of Course!
...
See also the list of authors who contributed to the original codebase for this project.
...
# BELOW IS THE README.md FROM THE RESPECTIVE REPO 
